...
Summarize failed-login patterns from a local authentication log.
...
Open <http://127.0.0.1:8088> in a browser. For CLI-capable tools, run `python3 app.py --help` to see the positional form.
